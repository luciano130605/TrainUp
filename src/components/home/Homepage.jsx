...
import recuperacionMuscularModal, { buildMuscleRecovery } from '../modales/recuperacionMuscularModal';
import "./HomePage.css";
    ...
    return (
        <>
            <div className="header">
                <div className='justifyContentSpaceBet'>
            ...
            <div className="cont">
                ...
                <div className="home-hoy-card">
                    <div className="home-hoy-head">
                        <span className="section-label acento-color">Hoy toca</span>
                    </div>
                    ...
                    {rutinasHoy.length === 0 ? (
                        ...
                        <div className="home-hoy-lista">
                            {rutinasHoy.map((r, i) => (
                                <div key={r.id} className="home-hoy-item routine-card-in"
                                    style={{
                                ...
                                >
                                    <div className="home-hoy-item-info" onClick={() => onSelectRoutine(r.id)}>
                                        ...
                                        <div>
                                            <div className="routine-name home-nombre">{r.name}</div>
                ...
                {(weeklyMuscles.length > 0 || exerciseProgress.length > 0) && (
                    <div className="home-msj-card routine-card-in">
                        <span className="section-label acento-color">Tu semana</span>
                                ...
                                >
                                    {weeklyGroups.map((group, page) => (
                                        <div key={page} className="home-week-page">
                                            {group.map((m, index) => (
                                                <div className="home-week-chip" key={m.muscle}>
                                                    <div className="home-week-chip-left">
                                                        <span className="set-idx done">
                                                            {page * 2 + index + 1}
                                                        </span>

                                                        <span className="routine-name home-nombre">
                                                            {m.muscle}
                                                        </span>
                                                    </div>
                            ...
                            <>
                                ...
                                >
                                    {exerciseProgress.map(p => (
                                        <div key={p.name} className="home-week-chip">
                                            {p.type === 'up' ? (
                                                <TrenUp size={25} color='var(--acento)' />
                                            ) : (
                                                <TrenDown size={25} color='var(--rojo)' />
                                            )}
                                            <span className="routine-name home-nombre" style={{
                                                paddingRight: 30
                                            }}>{p.name}</span>
                                            <span className="routine-meta">
                ...
                {history.length > 0 && (
                    <div className="home-recup-card routine-card-in">
                        <div className="home-recup-head" onClick={() => setProgresoOpen(true)}>
                            <span className="section-label acento-color">Recuperación muscular</span>
                            <ChevronRight size={16} className="home-quick-chev" />
                        </div>

                        {justRecovered && pendientes.length > 0 && (
                            <div className="home-recup-alert">
                                <span className="home-recup-alert-icon">💪</span>

                                <span>
                                    <strong>{justRecovered.muscle}</strong> recuperado
                                    <span className="home-recup-alert-separator">·</span>
                                    listo para entrenar
                                </span>
                            </div>
                        )}
                        ...
                        {pendientes.length === 0 ? (
                            <p className="sub textCenter">Todos tus músculos están recuperados 💪</p>
                        ) : (
                            <>
                                <div
                                ...
                                >
                                    {pendientes.map(r => (
                                        <div
                                            key={r.muscle}
                                            className="home-recup-item"
                                        >
                                            <div className="home-recup-icon">
                ...
                <div className="home-msj-card routine-card-in"
                    ...
                    <div className="section-label acento-color">Accesos rápidos</div>
                    <div
                    ...
                    >
                        <div className="home-quick-item" onClick={() => onNavigate('routines')}>
                            <div className="home-recup-icon"><RutinasIconFill /></div>
                            <span className='routine-name home-nombre'>Rutinas</span>
                            <ChevronRight size={14} className="home-quick-chev" />
                        </div>
                        <div className="home-quick-item" onClick={() => onNavigate('history')}>
                            <div className="home-recup-icon"><HistorialIconFill /></div>
                            <span className='routine-name home-nombre'>Historial</span>
                            <ChevronRight size={14} className="home-quick-chev" />
                        </div>
                        <div className="home-quick-item" onClick={() => onNavigate('mensajes')}>
                            <div className="home-recup-icon"><MsjIconFill /></div>
                            <span className='routine-name home-nombre'>Mensajes</span>
                            <ChevronRight size={14} className="home-quick-chev" />
                        </div>
                        <div className="home-quick-item" onClick={() => onNavigate('perfil')}>
                            <div className="home-recup-icon"><UserIconFill /></div>
                            <span className='routine-name home-nombre'>Perfil</span>
                            <ChevronRight size={14} className="home-quick-chev" />
                        </div>
                    </div>
                    <DotsIndicator
                ...
                {ultimoEntreno && (
                    <>
                        <div className="home-msj-card routine-card-in"
                            ...
                            <div className="section-label acento-color">Último entrenamiento</div>
                            <div
                                className="home-recup-item"
                                onClick={() => onSelectHistoryEntry?.(ultimoEntreno.id)}
                            >
                                <div className="home-recup-icon"><Dumbbell size={16} /></div>
                                <div className="home-ultimo-info">
                                    <div className="routine-name home-nombre">{ultimoEntreno.routineName}</div>
                                    <div className="routine-meta">
